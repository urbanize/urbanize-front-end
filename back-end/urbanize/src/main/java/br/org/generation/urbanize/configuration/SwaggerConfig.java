package br.org.generation.urbanize.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("br.org.generation.urbanize.controller"))
	...
	private static Contact contact() {
		...
		return new Contact("Urbanize", 
			"https://github.com/valterchess/projeto-integrador", 
			"valter.silva.dev@gmail.com");
